...
const ShoppingCart = () => {
    ...
    return ( 
        <>
        {
         ...
         {
            (loginPopupModel) && <ModalPOpUp ModalOpen={ModalClose} closeCart={toggleCart} orderNowPressed={orderNowPressed}/>
        }
         <div class="cart_box_container cart_info">
             {isOpenCart && <ContentCart closeCart={toggleCart} setalert={closeModal} setloginPopupModel={setloginPopupModel} setorderNowPressed={setorderNowPressed}/> }
