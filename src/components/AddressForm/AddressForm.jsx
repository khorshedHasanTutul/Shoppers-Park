...
const AddressForm = () => {
  ...
  const phoneFormatValid = phone.length > 0 && phone[0] === '0' && phone[1] === '1';
  const phoneInputIsInvalid =
    phoneIsTouched && (!phoneIsValid || !phoneFormatValid);
  ...
  let phoneValidityMessage;
  if(!phoneIsValid){
    phoneValidityMessage = `Phone Number is Required `;
  }
  if(!phoneFormatValid) {
    phoneValidityMessage = `${phoneValidityMessage} Phone number format is incorrect`;
  }
        ...
        <div className="add-left-content mb-16">
          ...
          <div className="form__control mb-16">
            <InputControl
              ...
              required
              className="brick"
              error={phoneInputIsInvalid && phoneValidityMessage}
              value={phone}
