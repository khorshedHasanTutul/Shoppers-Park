  ...
  const cuponSubmitButtonHandler = (e) => {
    ...
    http.post({
      ...
      payload: {
        ...
        CouponCode: cupon,
        OrderAmount: cartCtxModal.TotalAmmount,
        OrderDiscount: 0,
      },
      before: () => {
    ...
    <div class="tab-content checkout-main-tab-content">
      <div class="discount-cupon-payment">
        ...
        <form id="discount_codeSubmit">
          <div>
            ...
            {invalidCupon && (
              <div class="h-12">
                <p class="t-bold t-secondary t-12">Invalid Coupon Code.</p>
              </div>
            )}
            {validCupon && (
              <div class="h-12">
                <p class="t-bold t-primary t-12">
                  You Will Receive {cuponDiscount.toFixed(2)} BDT Discount.
                </p>
              </div>
            )}
          </div>
          <button type="submit" onClick={cuponSubmitButtonHandler}>
            Apply
          </button>
        </form>
      </div>
      ...
      <div className="payment-shaping-address-saveing-row">
        <div className="shapping-address-inner-content">
          ...
          <div className="saving-address-content">
            <small>
              {paymentShippingAddress
                ? paymentShippingAddress.Name
                : savedShippingData.Name}
            </small>
            <small>
              {paymentShippingAddress
                ? paymentShippingAddress.Mobile
                : savedShippingData.Mobile}
            </small>
            <span>
              <aside>
                {paymentShippingAddress
                  ? paymentShippingAddress.Type
                  : savedShippingData.Type}
              </aside>
            </span>
            <span>
              {paymentShippingAddress
                ? paymentShippingAddress.Email
                : savedShippingData.Email}
            </span>
            <span>
              {paymentShippingAddress
                ? paymentShippingAddress.Province +
                  "-" +
                  paymentShippingAddress.District +
                  "-" +
                  paymentShippingAddress.Upazila +
                  "-" +
                  paymentShippingAddress.Remarks
                : savedShippingData.Province +
                  "-" +
                  savedShippingData.District +
                  "-" +
                  savedShippingData.Upazila +
                  "-" +
                  savedShippingData.Remarks}
            </span>
          </div>
        </div>
      ...
      <div class="product-payment-block-tab">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="summary-details-p" colspan="2">
                  <strong>
                    {(
                      cartCtxModal.TotalAmmount +
                      parseInt(savedShippingInfo) -
        ...
        <div class="summary-notice-address">
          <p class="OrderNotice" styles="margin-top: 1%;">
        ...
        <div class="row-custom">
              ...
              <div class="order-outside-inside-flex">
                <p>
                  <input
                    ...
                    id="test3"
                    name="radio-group"
                    onClick={paymentSelectedHandler}
                  />
          ...
          <div class="cart_navigation">
            ...
            {OrderStatus && (
              <PopUpModal savedShippingDataMobile={savedShippingData.Mobile} />
            )}
          </div>
        </div>
      </div>
