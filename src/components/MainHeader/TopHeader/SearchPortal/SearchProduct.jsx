...
const SearchProduct = ({SearchValue,closeSearch,setalert}) => {
    ...
    return (
        <SearchPortal data={data} closeSearch={closeSearch} lowerSearchvalue={lowerSearchvalue} setalert={setalert}/>
    );
};
